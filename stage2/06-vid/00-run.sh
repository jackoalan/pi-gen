...
while ! DEB_BUILD_OPTIONS=nocheck dpkg-buildpackage -b -uc -ui -nc; do echo "Retrying build"; done
popd
dpkg -i libavformat58_4.3.1-*_armhf.deb libavformat-dev_4.3.1-*_armhf.deb libavcodec58_4.3.1-*_armhf.deb libavcodec-dev_4.3.1-*_armhf.deb libavdevice58_4.3.1-*_armhf.deb libavdevice-dev_4.3.1-*_armhf.deb libswscale5_4.3.1-*_armhf.deb libswscale-dev_4.3.1-*_armhf.deb libavutil56_4.3.1-*_armhf.deb libavutil-dev_4.3.1-*_armhf.deb libswresample3_4.3.1-*_armhf.deb libswresample-dev_4.3.1-*_armhf.deb libavfilter7_4.3.1-*_armhf.deb libavfilter-dev_4.3.1-*_armhf.deb libpostproc55_4.3.1-*_armhf.deb libpostproc-dev_4.3.1-*_armhf.deb
rm -rf ffmpeg*
rm -rf *.deb
